          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              ...
              <div className="mb-8 md:mb-0" >
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1" >Data Analysis Tools and Solutions</div>
                    <div className="text-gray-600">Assisting businesses in 30+ industries with data integration, consolidation, and analysis for department and enterprise-level needs.</div>
                  </div>
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Outlfy Brain Lab</div>
                    <div className="text-gray-600">Empowering founders to connect with every app user through a ChatGPT-like AI Replica called Outlfy Brain, fostering personalized conversations at scale via WhatsApp for enhanced customer satisfaction and business growth.</div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                      <path d="M11.854.146a.5.5 0 00-.525-.116l-11 4a.5.5 0 00-.015.934l4.8 1.921 1.921 4.8A.5.5 0 007.5 12h.008a.5.5 0 00.462-.329l4-11a.5.5 0 00-.116-.525z" fillRule="nonzero" />
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Development Lab</div>
                    <div className="text-gray-600">Helping companies to start or elevate their businesses from scratch through our development, consultancy, and marketing solutions.</div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                  <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                      <path d="M11.854.146a.5.5 0 00-.525-.116l-11 4a.5.5 0 00-.015.934l4.8 1.921 1.921 4.8A.5.5 0 007.5 12h.008a.5.5 0 00.462-.329l4-11a.5.5 0 00-.116-.525z" fillRule="nonzero" />
